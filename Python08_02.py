...
with open(output_file, 'w') as wFile:
    for key in dic:
        ...
        for i in range(0, len(seq_to_split), 3):
            split_seq += seq_to_split[i:i+3] + ' '  #adiciona cada códon separado por espaço
...
print(f"A sequência dividida em códons foi salva em {output_file}, gostaria de visualizar? s/n:")
...
if response == 's':
    ...
    print("Ok, não será exibido o conteúdo do arquivo.")
else:
